...
<div class="offcanvas offcanvas-start" tabindex="-1" id="sidebar">
    ...
    <div class="offcanvas-body p-0" style="background: var(--wa-bg);">
        <div class="list-group list-group-flush border-bottom mb-3">
            <a href="index.php"
                class="list-group-item list-group-item-action py-3 fw-semibold <?php echo ($pageTitle ?? '') === 'Feed' ? 'active' : ''; ?>">
                <i class="bi bi-chat-dots me-3 fs-5 text-secondary"></i> Feed de Mensagens
            </a>
            <a href="groups.php"
                class="list-group-item list-group-item-action py-3 fw-semibold <?php echo ($pageTitle ?? '') === 'Grupos' ? 'active' : ''; ?>">
                <i class="bi bi-people me-3 fs-5 text-secondary"></i> Lista de Grupos
            </a>
            <a href="schedules.php"
                class="list-group-item list-group-item-action py-3 fw-semibold <?php echo ($pageTitle ?? '') === 'Agendamentos' ? 'active' : ''; ?>">
        ...
        <div class="list-group list-group-flush border-bottom mb-3">
            <a href="send_message.php"
                class="list-group-item list-group-item-action py-3 fw-semibold <?php echo ($pageTitle ?? '') === 'Enviar Mensagem' ? 'active' : ''; ?>">
                <i class="bi bi-send-arrow-up me-3 fs-5 text-success"></i> Nova Mensagem
            </a>
            <a href="agents.php"
                class="list-group-item list-group-item-action py-3 fw-semibold <?php echo ($pageTitle ?? '') === 'Agentes de IA' ? 'active' : ''; ?>">
                <i class="bi bi-robot me-3 fs-5 text-warning"></i> Agentes de IA
            </a>
            <a href="send_status.php"
                class="list-group-item list-group-item-action py-3 fw-semibold <?php echo ($pageTitle ?? '') === 'Enviar Status' ? 'active' : ''; ?>">
        ...
        <div class="list-group list-group-flush">
            <a href="users.php" class="list-group-item list-group-item-action py-3 fw-semibold <?php echo ($pageTitle ?? '') === 'Gestão de Usuários' ? 'active' : ''; ?> text-primary">
                <i class="bi bi-people me-3 fs-5"></i> Gestão de Usuários
            </a>
