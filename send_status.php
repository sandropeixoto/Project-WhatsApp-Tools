        ...
        <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body px-4 pb-4">
                <div class="mb-3">
                    ...
                    <select id="status-type" class="form-select form-select-lg fs-6 bg-light border-0 mb-3"
                ...
                <div id="status-text-settings" class="row gx-3 mb-3">
                    <div class="col-6">
                        ...
                        <input type="number" id="status-bg" class="form-control bg-light border-0" value="19" min="1"
                            max="21">
                    </div>
                    <div class="col-6">
                        <label class="form-label small fw-semibold text-muted">Estilo da Fonte</label>
                        <select id="status-font" class="form-select bg-light border-0">
                ...
                <div id="status-media-container" class="mb-3" style="display: none;">
                    ...
                    <input type="url" id="status-file" class="form-control bg-light border-0"
                ...
                <div class="mb-3">
                    ...
                    <textarea id="status-text" class="form-control bg-light border-0" rows="3"
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        <label class="form-label small fw-semibold text-muted"><i class="bi bi-clock me-1"></i>Agendar
                            Publicação</label>
                        <select id="status-schedule" class="form-select bg-light border-0">
                ...
                <div class="d-grid pt-2">
                    <button class="btn btn-primary btn-lg fw-semibold" onclick="sendStatus()">
